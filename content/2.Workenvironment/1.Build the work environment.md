...
## Step 2: Downloading "apage" Template Files
...
## Step 5: Editing the Project and Running it for Preview
...
File > Open Folder > apage
::
- Once the edits are done, go to the Terminal within VSCode and type the command **npm run dev** to build and run the application.
